...
export const STR = {
  en: {
    ...
    notShippedYet: "We'll add tracking details once your order ships.",
    manageDelivery: "Delivery",
    deliveryOptionsIntro: "Set up named delivery options (courier + estimate + price) shown to customers at checkout.",
    freeDeliveryThreshold: "Free delivery above this order amount (NPR, 0 = disabled)",
    addDeliveryOption: "Add Delivery Option",
    optionNameLabel: "Option name (e.g. Standard - Nepal Post)",
    etaLabel: "Estimated time (e.g. 3-5 days)",
    zoneLabel: "Where this applies",
    zoneAll: "All of Nepal",
    zoneValley: "Bagmati / Kathmandu Valley only",
    zoneOutside: "Outside the Valley only",
    noDeliveryOptionsYet: "No delivery options yet — a standard flat rate is used until you add some.",
    shippingDetails: "Shipping Details",
    saveShipping: "Save Shipping Info",
    notifyCustomer: "Notify Customer via WhatsApp",
    codAvailableBadge: "Cash on Delivery available",
    total: "Total",
  ...
  np: {
    ...
    freeDeliveryUnlocked: "तपाईंले नि:शुल्क डेलिभरी पाउनुभयो!",
    chooseDeliveryOption: "डेलिभरी विकल्प छान्नुहोस्",
    courier: "कुरियर",
    trackPackage: "प्याकेज ट्र्याक गर्नुहोस्",
    trackingNumber: "ट्र्याकिङ नम्बर",
    trackingUrl: "ट्र्याकिङ लिङ्क",
    notShippedYet: "तपाईंको अर्डर पठाइएपछि हामी ट्र्याकिङ विवरण थप्नेछौं।",
    manageDelivery: "डेलिभरी",
    deliveryOptionsIntro: "चेकआउटमा ग्राहकलाई देखिने नामांकित डेलिभरी विकल्पहरू (कुरियर + अनुमानित समय + मूल्य) सेटअप गर्नुहोस्।",
    freeDeliveryThreshold: "यो अर्डर रकम भन्दा माथि नि:शुल्क डेलिभरी (रु., ० = बन्द)",
    addDeliveryOption: "डेलिभरी विकल्प थप्नुहोस्",
    optionNameLabel: "विकल्पको नाम (जस्तै स्ट्यान्डर्ड - नेपाल पोस्ट)",
    etaLabel: "अनुमानित समय (जस्तै ३-५ दिन)",
    zoneLabel: "यो कहाँ लागू हुन्छ",
    zoneAll: "सम्पूर्ण नेपाल",
    zoneValley: "बागमती / काठमाडौं उपत्यका मात्र",
    zoneOutside: "उपत्यका बाहिर मात्र",
    noDeliveryOptionsYet: "अहिलेसम्म कुनै डेलिभरी विकल्प छैन — नथप्दासम्म मानक निश्चित दर प्रयोग हुन्छ।",
    shippingDetails: "ढुवानी विवरण",
    saveShipping: "ढुवानी विवरण सुरक्षित गर्नुहोस्",
    notifyCustomer: "WhatsApp मार्फत ग्राहकलाई सूचित गर्नुहोस्",
    codAvailableBadge: "डेलिभरीमा नगद भुक्तानी उपलब्ध",
    total: "जम्मा",
